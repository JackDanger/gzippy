...
#[cfg(parallel_sm)]
pub use instruments::{
    decode_bypass, markerpp_perturb, memlife, perfect_overlap, phase_timing, region_prof,
    removal_oracle, rss_inflate, seed_windows, stall_residency, trace_jsonl as trace,
