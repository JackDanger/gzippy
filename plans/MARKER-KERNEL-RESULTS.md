...
## Boxes / Gate-0 / Gate-4
- **AMD solvency** EPYC 7282 Zen2 `root@REDACTED_IP` (PRIMARY — the gap lives here). FROZEN
...
- **Intel neurotic** i7-13700T LXC `ssh -J REDACTED_IP root@REDACTED_IP` (unfreezable):
