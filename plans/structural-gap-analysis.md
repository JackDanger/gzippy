...
trace_{gzippy,rapidgzip}_T8.json). Fulcrum tool source: `/Users/jackdanger/www/fulcrum/src/`.
...
### 1.2 `causal` view (`/Users/jackdanger/www/fulcrum/src/causal.rs:260-297`)
...
### 1.3 `model` view (`/Users/jackdanger/www/fulcrum/src/model.rs:244-260`)
