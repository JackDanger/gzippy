...
LXC `ssh -J 10.0.0.100 root@10.30.0.199`, i7-13700T, gov=powersave/no_turbo=0
...
`ssh root@10.0.2.240`, EPYC 7282 Zen2, FROZEN gov=performance/boost=0, llama-server +
