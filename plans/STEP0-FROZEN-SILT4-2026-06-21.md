...
**Box:** Intel i7-13700T LXC (neurotic guest 10.30.0.199), **FROZEN** via host
`10.0.0.100:/root/bench-lock.sh acquire 2400` (no_turbo=1, governor=performance pinned,
...
## Reproduce
```
ssh root@10.0.0.100 /root/bench-lock.sh acquire 2400 && ssh root@10.0.0.100 /root/bench-lock.sh status
# build native gz on guest @8081516b (RUSTFLAGS=-C target-cpu=native, --no-default-features --features pure-rust-inflate)
ssh -J 10.0.0.100 root@10.30.0.199 'GZ=/dev/shm/gzrg-target/release/gzippy RG=/root/oracle_c/rapidgzip-native N=13 PIN_T1=3 PIN_T4=2,4,6,8 bash /root/step0_frozen_driver.sh'
