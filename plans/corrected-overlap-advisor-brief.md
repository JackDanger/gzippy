...
## THE DECIDER NUMBER (T8, measure.sh interleaved N=11, sha-OK every run, CPUS=0,2,4,6,8,10,12,14, locked guest REDACTED_IP, gov=perf, turbo-on, load 0.5-0.85; 3 runs)
