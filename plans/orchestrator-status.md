...
**FROZEN-GUEST MEASUREMENTS** (10.30.0.199, bench-lock --lock, no_turbo=1, governor=performance,
...
**FROZEN-GUEST MEASUREMENTS** (10.30.0.199, driver --lock, runnable_avg 1.00-1.75 <=2.0,
...
**FROZEN-GUEST MEASUREMENTS** (10.30.0.199, no_turbo=1, BENCH_LOCK=quiet runnable_avg 1.00-1.25,
...
**FROZEN-BOX MEASUREMENTS** (guest 10.30.0.199, no_turbo=1, BENCH_LOCK=quiet, runnable_avg
...
MEASURED (frozen quiet guest 10.30.0.199, T4, interleaved best-of-N, same-sink ->/dev/shm
...
RE-MEASURED (frozen guest 10.30.0.199, gzippy bin_sha e32829a8, sha==028bd002…):
...
NUMBERS (frozen guest "trainer" 10.30.0.199, bench-lock no_turbo=1 gov=performance,
...
NUMBERS (frozen guest 10.30.0.199, bench-lock no_turbo=1 gov=performance, quiet runnable_avg=1.00,
...
Charter plans/t4-contention-cache-residency.md. Frozen guest 10.30.0.199 (bench-lock, no_turbo=1
