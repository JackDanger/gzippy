...
The guest (`10.30.0.199`) sits behind the jump host `neurotic`. Two forms exist
...
ssh -o ConnectTimeout=15 -J neurotic root@10.30.0.199 "…"

# LEGACY nested form (avoid — longer, easy to mis-quote, wedges the channel):
ssh neurotic 'ssh 10.30.0.199 "…"'
```
