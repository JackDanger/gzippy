...
//!
//! # Why this lives here, not in `src/decompress/parallel/fast_marker_inflate.rs`
//!
...
//! - **B7**: false-positive boundary that ISA-L accepts but `validate_boundary`
//!   rejects — synthesize an adversarial bit-stream and confirm
//!   rejection.
